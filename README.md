This project is using [Laravel](https://github.com/laravel/laravel). If you're not familiar with that go over to their page and check it out. This way you can see how to start the project on your end.
